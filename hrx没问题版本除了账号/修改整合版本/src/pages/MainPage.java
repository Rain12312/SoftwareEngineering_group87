...
public class MainPage extends BasePage {
    ...
    private JPanel createTransactionsCard() {
        ...
        for (Transaction t : lastSevenDaysTransactions) {
            ...
            listPanel.add(createTransactionItem(t.getCategory(), amount, t.getNotes()));
        }
        listPanel.add(Box.createVerticalGlue());

        // 用 JScrollPane 包裹账单列表
        ...
        scrollPane.setPreferredSize(new Dimension(Integer.MAX_VALUE, 220)); // 固定高度
        // 设置滚动条为透明
    ...
    private JPanel createTransactionItem(String category, String amount, String notes) {
        ...
        categoryLabel.setFont(new Font("Microsoft YaHei", Font.BOLD, 14));
        categoryLabel.setForeground(TEXT_COLOR);
        leftPanel.add(categoryLabel);

        if (notes != null && !notes.isEmpty() && !notes.equals("add some notes....")) {
            leftPanel.add(Box.createHorizontalStrut(5));
            JLabel notesLabel = new JLabel(notes);
            notesLabel.setFont(new Font("Microsoft YaHei", Font.PLAIN, 14));
        ...
        amountLabel.setFont(new Font("Microsoft YaHei", Font.BOLD, 14));
